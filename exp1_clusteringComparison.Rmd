...
kmeanClusterPlot<-function(sce,prefix){
  ...
  #label clusters and compare with original labels
}
...
bayesSpaceClusterPlot<-function(sce,prefix){
  ...
  res=cowplot::plot_grid(c0,c1)
  print(res)

  ggsave(paste0(prefix,'Islet.pdf'),res)
  ggsave(paste0(prefix,'Islet.png'),res)
...
```
Now that we defined the clustering funcitons we can compare
